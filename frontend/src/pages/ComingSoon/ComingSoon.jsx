 ...
 * 024, redesigned around the brand assets in 033). It shows the logo
 * (alt text the site's name), says "Coming Soon", and offers the
 * waiting-list form — and nothing else: no 8.01 item, no program
 * description, no field of study, no course, and never a word about the
 * Registry — partial disclosure reads as descriptive material, so the
 * eleven items publish with the course (016) and not before. The form
 * asks only for what the API requires and describes nothing about what
 * the email will say. It never links /login. No font, script, or image
 * is fetched from anywhere but this origin.
 */
